...
namespace WindowsForms_showAPM
{
  public partial class FormMain : Form
  {
    ...
    private int totalKeyAPM = 0;
    private int totalMouseAPM = 0;

    private int thisSecondsCounter = 0;
    private int thisSecondsMouseCounter = 0;
    private int thisSecondsKeyCounter = 0;
    ...
    private int[] apmSecondsKey;
    private int[] apmSecondsMouse;

    private int[] apmChartData;
    private int[] apmChartKeyData;
    private int[] apmChartMouseData;
    ...
    private void FormMain_Load(object sender,EventArgs e)
    {
      ...
      apmSecondsKey = new int[60];
      apmSecondsMouse = new int[60];
      for ( int i = 0; i < 60; i++ )
      {
        apmSeconds[i] = 0;
        apmSecondsKey[i] = 0;
    ...
    {// refresh the APM chart
     //DRAW APM 1 MINITE CHART
      ...
      chart1MinApm.Series.Add(series1MinApmMouseTotal);
    ...
    {//conut keyboard key down
     //addCounter_one();     //only for test
      addOneAPMToSecondsKeyCounter();
    }
    ...
    {//count mouse click
     ...
     // so ,how can we let those action in different method ?? need to finish
      ...
      {
        //addCounter_one();     //only for test
        addOneAPMToSecondsMouseCounter();
      }
    }
    ...
    private void addOneAPMToSecondsKeyCounter()
    {
      addOneAPMToSecondsCounter();
      thisSecondsKeyCounter++;
    }


    private void addOneAPMToSecondsMouseCounter()
    {
      addOneAPMToSecondsCounter();
      thisSecondsMouseCounter++;
    }
    ...
    private void calculateSecondAPM()
    {
      ...
      apmSecondsKey[secondNow] = thisSecondsKeyCounter;
      apmSecondsMouse[secondNow] = thisSecondsMouseCounter;
    ...
    private void initialChart()
    {
      ...
      series1MinApmTotal.BorderColor = Color.FromArgb(200,255,0,200);
      series1MinApmTotal.Color =Color.FromArgb(90,255,0,220);
      chart1MinApm.Series.Add(series1MinApmTotal);

      series1MinApmMouseTotal.ChartType = SeriesChartType.Area;
      series1MinApmMouseTotal["PointWidth"] = "0.6";
      series1MinApmMouseTotal.IsValueShownAsLabel = false;//是否显示值
      series1MinApmMouseTotal.BorderColor = Color.FromArgb(80,26,255,255);
      series1MinApmMouseTotal.Color =Color.FromArgb(60,0,100,200);
      chart1MinApm.Series.Add(series1MinApmMouseTotal);
